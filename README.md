...
* `/Sales-Prediction` — Multivariate advertising investment optimization analysis.
* `/Unemployment-Analysis-India` — Time-series economic impact assessment of Covid-19.
...
* **Results:** 
  * Achieved an overall model accuracy of **90.00%**.
...
* **Results:** 
  * Achieved an exceptional $R^2$ Score of **0.9937** using **Linear Regression**.
...
* **Results:** 
  * Documented a massive surge in the monthly average unemployment rate, peaking near **23%** in May 2020 following lockdown measures.
  * Identified **Haryana** ($27.5\%$) and **Tripura** ($25.1\%$) as the hardest-hit states by average unemployment rate.
  * Highlighted a significant variance in the post-Covid data, with urban areas suffering a sharper spike compared to rural sectors.
...
2. Install required dependencies:
   ...
   ```
3. Open and run the Jupyter Notebooks or Python files.
